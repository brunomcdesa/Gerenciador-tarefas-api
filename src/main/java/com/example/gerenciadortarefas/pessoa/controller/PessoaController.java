...
public class PessoaController {
    ...
    @GetMapping("gastos")
    public PessoaGastoResponse buscarMediaHorasGastas(@RequestParam String nome, @RequestParam LocalDate dataInicial,
                                                      @RequestParam LocalDate dataFinal) {
        return service.buscarMediaHorasGastas(nome, dataInicial, dataFinal);
    }
}
